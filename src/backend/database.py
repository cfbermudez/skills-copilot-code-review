...
initial_announcements = [
    {
        ...
        "message": "Join an exciting extracurricular activity this season! Registration is now open for all activities. Don't miss out on the opportunity to develop new skills and make lasting friendships.",
        "start_date": None,
        "expiration_date": "2026-05-31T23:59:59",
